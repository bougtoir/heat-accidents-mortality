...
run = title_p.add_run(
    "There is no 'typical Japanese patient': regional variation in "
    'pain-related prescribing across Japan\'s 47 prefectures'
)
run.bold = True
run.font.size = Pt(14)
...
abstract_results = (
    f'Acute analgesic prescribing varied {acute_fold_ratio:.2f}-fold across prefectures '
    f'(Kruskal\u2013Wallis P{fmt_p(acute_kruskal_p)}). '
    f'Tohoku\u2014traditionally considered Japan\u2019s most stoic region\u2014prescribed more, '
    f'not fewer, analgesics (Cohen\u2019s d={acute_d:.2f}). '
    f'Unadjusted neuropathic pain prescribing showed a large Tohoku excess '
    f'(d={unadj_d:.2f}), but diabetes drug prescribing was a strong confounder (r={diabetes_r:.2f}). '
...
r2 = (
    ...
    f'ranked {tohoku_rank} of nine with a mean index of {tohoku_acute_mean:.2f} (SD {tohoku_acute_sd:.2f}), '
...
d3 = (
    f'The {acute_fold_ratio:.2f}-fold within-Japan variation has direct clinical relevance for any physician '
...
d3b = (
    ...
    f'Our finding of {acute_fold_ratio:.2f}-fold within-Japan variation directly refutes this assumption. '
...
d5 = (
    ...
    f'indices (r={acute_adj_r:.2f}, P{fmt_p(acute_adj_p)}) suggests a modest link between regional acute pain '
...
d7 = (
    ...
    f'{acute_fold_ratio:.2f}-fold across prefectures. Any clinician who adjusts analgesic dosing based on the '
...
doc.add_paragraph(
    ...
    'https://github.com/bougtoir/bbb-bhb-research/tree/main/ndb-pain-regional-variation-japan.')
